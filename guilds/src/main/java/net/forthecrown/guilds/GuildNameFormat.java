...
public class GuildNameFormat {
  ...
  private static final Style noStyle = Style.empty();

  public static final String BRACKETS_KEY = "brackets";
  public static final String COLORS_KEY = "colors";
  public static final String STYLE_KEY = "style";

  public static final int OPENING_BRACKET = 0;
  public static final int GUILD_NAME = 1;
  public static final int CLOSING_BRACKET = 2;
  ...
  public static GuildNameFormat createDefault() {
    return new GuildNameFormat(Bracket.DEFAULT, Color.DEFAULT, Stylee.DEFAULT);
  }
  ...
  public enum Bracket implements FtcKeyed {
    ...
    static final Registry<Bracket> REGISTRY = Registries.ofEnum(Bracket.class);
  ...
  public enum Color implements FtcKeyed {
    ...
    GRADIENT_2COLORS("gradient2") {
      ...
      public Component apply(
        ...
        return Guilds.createNameGradient(1, fullName, primary, secondary, bracket, text);
      }
    },
    GRADIENT_3COLORS("gradient3") {
      ...
      public Component apply(
        ...
        return Guilds.createNameGradient(2, fullName, primary, secondary, bracket, text);
      }
    },
    GRADIENT_4COLORS("gradient4") {
      ...
      public Component apply(
        ...
        return Guilds.createNameGradient(3, fullName, primary, secondary, bracket, text);
      }
    },
    ;

    static final Registry<Color> REGISTRY = Registries.ofEnum(Color.class);
     ...
     *
     * @param fullName  The full name array containing the opening bracket, the guild's name, and
     *                  the closing bracket. Use the {@link #CLOSING_BRACKET}, {@link #GUILD_NAME}
     *                  and {@link #OPENING_BRACKET} constants to access their respective values.
  ...
  public enum Stylee implements FtcKeyed {
    DEFAULT("default", noStyle, noStyle),
    FATB("boldBrackets", Style.style(TextDecoration.BOLD), noStyle),
    ITALIC("italic", Style.style(TextDecoration.ITALIC), Style.style(TextDecoration.ITALIC)),
    ITALIC_FATB("boldBracketsItalic", Style.style(TextDecoration.ITALIC, TextDecoration.BOLD), Style.style(TextDecoration.ITALIC)),
    FAT_STRIKED_B("strikedBoldBrackets", Style.style(TextDecoration.STRIKETHROUGH, TextDecoration.BOLD), noStyle),
    ;

    static final Registry<Stylee> REGISTRY = Registries.ofEnum(Stylee.class);
