...
public @UtilityClass class Particles {
  ...
  public void line(Vector3d origin, Vector3d target, double dist, World world,
                   ParticleBuilder builder
  ) {
  ...
  public void shape(double dist, World world, ParticleBuilder builder, boolean connectLastToFirst,
                    Vector3d... points
  ) {
