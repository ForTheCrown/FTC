...
/**
 * A set of {@link ContextOption}s that apply to a certain inventory.
 */
...
public class ContextSet {
   ...
   * <p>
   * Delegate method for {@link #newOption(Object)} with null parameter
   *
  ...
  /**
   * Creates an inventory context of this set's options. All options within the created context will
   * have each option's default values.
   *
