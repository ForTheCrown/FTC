...
/**
 * A functional interface for {@link MenuNode} for placing items when an inventory is opened
 */
@FunctionalInterface
public interface MenuNodeItem {
  ...
  /**
   * Creates a node which returns the given function's result.
   * <p>
   * The function is essentially a context-less version of the {@link MenuNodeItem} function
   *
