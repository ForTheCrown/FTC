...
/**
 * A serializer parser is an object which provides a common way to both serialize/deserialize and
 * parse/format a type of object.
 * <p>
 ...
 * specific types of global variables. Currently, however, this system is barely used, except for
 * {@link net.forthecrown.waypoint.WaypointProperty} instances.
 * <p>
 * Note that this class uses the DataFixerUpper {@link DynamicOps} interface as a means to
 * serialize/deserialize from any serialization format.
 *
...
public interface SerializerParser<T> {
   ...
   * <p>
   * By default, this will call {@link #asString(Object)} with the given value and pass that onto a
   * text component
   *
   * @param value The value to format
  ...
  /**
   * Gets the argument type that parses string input and optionally provides completion suggestions
   *
  ...
  /**
   * Serializes the given value into the given serialization format.
   *
  ...
  /**
   * Deserializes a value from the given serialization format's object.
   *
