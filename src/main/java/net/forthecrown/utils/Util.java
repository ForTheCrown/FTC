...
/**
 * General Utility functions as well as some useful variables, like variables for the two main
 * worlds, world and world_void and the server's time zone lol
 */
public final class Util {
  ...
  /**
   * Performs the given input as a command executed by the server's console
   *
   ...
   */
  public static @FormatMethod IllegalArgumentException newException(@FormatString String format,
                                                                    Object... args
  ) {
