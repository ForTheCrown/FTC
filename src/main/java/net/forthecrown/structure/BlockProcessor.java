...
/**
 * A processor for a single block that's being placed by a
 * {@link BlockStructure}.
 */
@FunctionalInterface
public interface BlockProcessor {
   ...
   * <p>
   * The processors are ran as a list for every single block that's placed, this
   * means that the given block data will be modified by a processor and then
   * passed onto the next processor in the list.
   * <p>
   * If the final result of all processors being ran is null, then no block is
   * placed, otherwise the returned block data will be placed.
   *
