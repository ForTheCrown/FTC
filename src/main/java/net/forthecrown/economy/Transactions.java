...
public @UtilityClass class Transactions {
  ...
  /**
   * Field that represents the receiver, aka the target, of the transaction, may be unset, in the
   * case of money being given to the server
   */
  public final SchemaField<String> T_TARGET;

  /**
   * Represents the entity in a transaction sending rhines to the other party, may be unset, in the
   * case of the server giving money to a user
   */
  public final SchemaField<String> T_SENDER;

  /**
   * Arbitrary random data about the transaction, unique to each {@link TransactionType}
   */
  public final SchemaField<String> T_EXTRA;

  /**
   * The amount of Rhines that were exchanged in the transaction
   */
