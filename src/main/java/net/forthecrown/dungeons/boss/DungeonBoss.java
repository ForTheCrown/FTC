...
/**
 * A very basic and generic interface representing a Dungeon Boss
 */
public interface DungeonBoss extends Listener {
  ...
  /**
   * Gets the check that anyone attempting to spawn the boss must pass
   *
   * @return The spawning requirement, null if there's no requirement for spawning the boss
   */
  ...
  /**
   * Gets a specific component in this boss' component list
   *
   * @param clazz The component's class
   * @param <T>   The type of component
   * @return The component, null, if there are no components or if the component wasn't found
   */
   ...
   * Kills the boss
   *
   * @param force Whether to force its death, true for stuff like server restarts
   */
   ...
   *
   * @return Current battle's context, null, if the boss isn't alive
   */
  ...
  /**
   * Gets the bounding box of the room the boss is in
   *
  ...
  /**
   * Gets the location the boss is meant to spawn at
   *
