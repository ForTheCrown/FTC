...
public class ActionEntranceInfo extends UsageAction {
  ...
  public static ActionEntranceInfo parse(StringReader reader, CommandSource source)
  ...
  public enum Type {
    ...
    LEVEL_INFO(
        "Right-clicking this will show you a list of items needed to spawn the level's boss.");
