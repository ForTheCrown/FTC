...
/**
 * A trigger manager which is used to manage all triggers created by commands.
 * <p>
 * It writes all triggers to a global_triggers.dat file in the plugin directory
 */
