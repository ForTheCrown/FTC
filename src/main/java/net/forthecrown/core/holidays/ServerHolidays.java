...
public class ServerHolidays extends SerializableObject.NbtDat {
  ...
  /**
   * Deactivates the given holiday. What this means is that it will go through every users' mail and
   * remove the given holiday's rewards from it, if they have not claimed the rewards.
   *
  ...
  /**
   * Runs the given holiday, gives all the rhine and/or gem rewards and items to all players by
   * sending it to their mailbox
   *
