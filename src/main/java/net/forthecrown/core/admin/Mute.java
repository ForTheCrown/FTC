...
public enum Mute {
  ...
  /**
   * The prefix to use in the {@link EavesDropper} message
   */
  private final String prefix;

  /**
   * True, if this status allows users to send messages that other players can see, false otherwise
   */
  private final boolean visibleToOthers;

  /**
   * Determines if the user that sent a message is allowed to see the message they sent if they have
   * this status
   */
