...
public final class StaffChat {
  ...
  public static void send(@NotNull CommandSource sender, @NotNull Component message, boolean cmd) {
    ...
    TextComponent text = Component.text()
        ...
        .append(
            Component.text(" > ").style(Style.style(NamedTextColor.DARK_GRAY, TextDecoration.BOLD)))
        .append(message)
        .build();
  ...
  /**
   * Sends a message to the staff chat in a command format, example: '[Staff] source_name: message'
   *
