...
/**
 * Wrapper for the regular Log4J logger used by FTC to enable DEBUG logging
 * in debug contexts.
 * <p>
 * Any message given to this logger at the {@link Level#DEBUG} level will not be
 * output unless the plugin itself is in debug mode, determined by
 * {@link FTC#inDebugMode()}.
 */
@Getter
