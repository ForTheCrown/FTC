...
public class Registry<V> implements Iterable<V> {
    ...
    /**
     * This registry's ID, generated independently of the
     * {@link Registries#ROOT} registry ID, if this registry
    ...
    Registry(boolean freezingAllowed) {
        this.registryId = nextRegistryId++;
     ...
     * @see #register(String, Object, int)
     */
    public @NotNull Holder<V> register(@Pattern(VALID_KEY_REGEX) String key, @NotNull V value)
     ...
     * @see #register(Holder)
     */
    public @NotNull Holder<V> register(@Pattern(VALID_KEY_REGEX) String key, @NotNull V value, @NonNegative int id)
            throws IllegalArgumentException, NullPointerException
    {
     ...
     */
    private @NotNull Holder<V> register(@NotNull Holder<V> holder) throws IllegalArgumentException, NullPointerException {
        testFrozen();
        ...
        if (contains(holder.getId())) {
            throw newException("Registry already contains mapping for id %s, key: '%s'",
        ...
        byValue.put(holder.getValue(), holder);
     ...
     */
    public boolean remove(@Pattern(VALID_KEY_REGEX) String key) throws IllegalArgumentException {
     ...
     */
    static @FormatMethod IllegalArgumentException newException(@FormatString String format, Object... args) {
