...
public final class ArrowEffects {
  ...
  public static final ArrowEffect
      ...
      CUPIDS_ARROWS = new ArrowEffect(13, Particle.HEART, "Cupid's Arrows",
          "Time to do some matchmaking..."),
      CUPIDS_TWIN = new ArrowEffect(14, Particle.DAMAGE_INDICATOR, "Cupid's Evil Twin",
          "Time to undo some matchmaking..."),
      STICKY_TRAIL = new ArrowEffect(15, Particle.DRIPPING_HONEY, "Sticky Trail",
          "For those who enjoy looking at the trail lol"),
      ...
      FIREWORK = new ArrowEffect(20, Particle.FIREWORKS_SPARK, "Firework",
          "Almost as if you're using a crossbow");
}