...
/**
 * A user component is an object attached to a user that can be serialized and deserialized.
 * <p>
 * Please see {@link Components} for further info on how user components function.
 */
