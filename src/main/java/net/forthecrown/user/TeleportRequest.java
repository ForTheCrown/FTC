...
import static net.forthecrown.core.Messages.REQUEST_ACCEPTED;
import static net.forthecrown.core.Messages.REQUEST_CANCELLED;
import static net.forthecrown.core.Messages.REQUEST_DENIED;
import static net.forthecrown.core.Messages.requestAccepted;
import static net.forthecrown.core.Messages.requestCancelled;
import static net.forthecrown.core.Messages.requestDenied;
...
/**
 * A request from user to another for one to teleport to the other.
 */
...
public class TeleportRequest {
   ...
   * this request after {@link GeneralConfig#tpaExpiryTime} ticks.
   */
  public void run() {
    //Add the request
