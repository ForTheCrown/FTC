 ...
 * to {@link Registries#USER_PROPERTIES} when
...
public abstract class UserProperty<T> {
     ...
     * more specifically the {@link Registries#USER_PROPERTIES} registry
     */
    ...
    public UserProperty(@NotNull String name, @NotNull T defaultValue) {
        ...
        var holder = Registries.USER_PROPERTIES.register(name, this);
