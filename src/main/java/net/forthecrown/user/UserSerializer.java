 ...
 * <p>
 * This exists so the format/way a user object is serialized can change without much interference to
 * the rest of the user system. Perfect if, for example, we wanted to switch to serializing users in
 * a database instead of in json files in a server directory
 */
