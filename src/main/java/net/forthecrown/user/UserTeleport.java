...
public class UserTeleport {
  ...
  /**
   * Determines if the teleports 3-second delay should be bypassed or not
   */
  @Getter
  @Setter
  ...
  /**
   * Determines if the teleport should occurr in async, note that
   * {@link GeneralConfig#useAsyncTpForPlayers} is also checked before an async teleport is
   * initiated
   */
  @Getter
  @Setter
  ...
  /**
   * The message to display to the user when the teleportation starts
   */
  @Getter
  @Setter
  ...
  /**
   * The message to display to the user when the teleportation is completed
   */
  @Getter
  @Setter
  ...
  /**
   * The message to display to the user when the teleport is interrupted
   */
  @Getter
  @Setter
