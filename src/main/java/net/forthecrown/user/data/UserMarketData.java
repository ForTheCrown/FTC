...
/**
 * Stores the data of who wants to merge their shops with this user
 */
public class UserMarketData extends UserComponent {

  /**
   * The ID of the owner of the shop this user last sent a merge request to
   */
  @Getter
  @Setter
  ...
  /**
   * A list all incoming market merge requests. UUID here represents the owner of the shop that
   * wants to merge
   */
  ...
  /**
   * Tests if the given UUID has sent a market merge request to this user
   *
  ...
  /**
   * Removes a market merge request sent by the given user
   *
  ...
  /**
   * Clears the incoming market merge requests sent to this user.
   * <p>
   * This will also set the {@link #setOutgoing(UUID)} to null on all the users in the incoming
   * list
   */
