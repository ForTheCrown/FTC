...
/**
 * A {@link UserComponent} that tracks time stamps, specified by {@link TimeField}s.
 */
public class UserTimeTracker extends UserComponent {
  ...
  /**
   * The value returned by {@link #get(TimeField)} if the given field has not been set.
   */
   ...
   * <p>
   * If the given field is not set when this is called, the field is simply set to the given value
   *
   ...
   * @return The field's value, returns {@link #UNSET} if the field has not been set
   */
   ...
   * @return True, if the field's value is anything other than {@link #UNSET}
   */
   ...
   * <p>
   * Functionally, this just fills the time stamp array with {@link #UNSET} values
   */
  public void clear() {
