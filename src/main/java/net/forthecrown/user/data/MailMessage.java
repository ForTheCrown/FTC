...
/**
 * A small class that holds the data for a mail message, when it was sent and by whom and what it
 * contains.
 */
@Data
public class MailMessage implements JsonSerializable {
  ...
  /**
   * The ID of the user that sent this message, if this was sent by a system message, this will be
   * null
   */
  ...
  /**
   * A rhine/gem/item attachment this message may hold, will be null if there's no attachment.
   * <p>
   * To stay safe though,use {@link MailAttachment#isEmpty(MailAttachment)} to test if the
   * attachment actually contains any useful data
   */
