 ...
 */
public class UserScoreMap extends SerializableObject.Json implements Iterable<UserScoreMap.Entry> {
    /**
    ...
    public UserScoreMap(Path path) {
        this(path, () -> MINIMUM_VALUE);
    }

    public UserScoreMap(Path filePath, IntSupplier defaultSupplier) {
        super(filePath);
    ...
    public static class Entry implements Comparable<Entry> {
        ...
        @Override
        public int compareTo(@NotNull UserScoreMap.Entry o) {
