...
public class InventoryPos {
    ...
    public InventoryPos(int column, int row) {
        Validate.isTrue(MathUtil.inRange(column, 0, 8), "Column cannot be more than 8 and less than 0, found: " + column);
        Validate.isTrue(MathUtil.inRange(row, 0, 5), "Row cannot be more than 5 and less than 0, found: " + row);
