...
public interface UserHomes extends UserAttachment {
    ...
    /**
     * Gets the region that's home to this user
     * @return The user's home region, null if not set
     */
    RegionPos getHomeRegion();

    /**
     * Sets the user's home region
     * @param cords The region cords at which their home will be.
     */
    void setHomeRegion(RegionPos cords);

    /**
     * Gets whether the user has a set home region
     * @return Whether the user has a home region.
     */
    default boolean hasHomeRegion() {
