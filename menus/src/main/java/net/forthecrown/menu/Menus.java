...
public final class Menus {
  ...
  /**
   * Creates a border item with the given material and empty name
   *
   ...
   * <p>
   * Bukkit states that a valid size 'is a multiple of 9' but that's not the whole truth, the size
   * cannot be less than {@link #MIN_INV_SIZE} and cannot be greater than {@link #MAX_INV_SIZE} and
   * the size must be a multiple of 9 as well.
   *
  ...
  /**
   * Creates a menu builder with {@link #DEFAULT_INV_SIZE} for the size
   *
  ...
  /**
   * Creates a menu builder with the given size, {@link #isValidSize(int)} must return true for the
   * given size else an exception will be thrown
   *
  ...
  /**
   * Creates a menu builder with the given size and title. {@link #isValidSize(int)} must return
   * true for the given size else an exception will be thrown
   *
