...
/**
 * An upgrade is something that is applied to a weapon when it ascends to a certain rank
 */
public interface WeaponUpgrade {
  ...
  /**
   * Gets the text to display in the item's lore under the "Next Upgrade: " section
   *
  ...
  /**
   * Gets the flavor text this upgrade will display, will remain until a following upgrade replaces
   * the text
   *
  ...
  /**
   * Gets the display name to display under the "When in main hand" lind in the lore.
   *
