package net.forthecrown.inventory.commands;

import static net.forthecrown.command.DataCommands.HELD_ITEM_ACCESSOR;
...
import net.forthecrown.inventory.ItemsPermissions;
...
public class CommandRoyalSword extends FtcCommand {
  ...
  private static final CommandSyntaxException NOT_HOLDING_ROYAL_SWORD
      = Exceptions.create("You must be holding a royal sword");
  ...
  public CommandRoyalSword() {
    ...
    setPermission(ItemsPermissions.ROYAL_SWORD);
    register();
  }
