...
/**
 * A utility object which joins a list of {@link Component}s together to form a single component
 * text.
 */
...
public class TextJoiner implements ComponentLike {
  ...
  /**
   * The text that will be prepended onto the joiner's result.
   */
  @Getter
  @Setter
  ...
  /**
   * The text that will be appended to the joiner's result
   */
  @Getter
  @Setter
  ...
  /**
   * The text that separates values in the joiner's entry list
   */
  @Getter
  @Setter
  ...
  /**
   * Creates a new joiner with a <code>null</code> delimiter, suffix and prefix
   *
  ...
  /**
   * Creates a new joiner with {@link Component#space()} as the delimiter.
   *
   * @return The created joiner
   */
  ...
  /**
   * Creates a new joiner with {@link Component#newline()} as the delimiter.
   *
   * @return The created joiner
   */
  ...
  /**
   * Builds the current entries into a single joined component.
   *
