...
public abstract class PagedIterator<T> implements Iterator<T> {
   ...
   * <p>
   * This constructor calls the {@link #PagedIterator(int, int, int, int, int)} with
   ...
   */
  public PagedIterator(int page, int size, int pageSize) {
   ...
   */
  public PagedIterator(int page, int size, int pageSize, int start, int end) {
    this.page = page;
    this.size = size;
   ...
   */
  public static <T> PagedIterator<T> of(List<T> list, int page, int pageSize) {
    return new PagedIterator<>(page, list.size(), pageSize) {
      @Override
   ...
   * @return The created iterator
   */
  public static <T> PagedIterator<T> reversed(List<T> list, int page, int pageSize) {
   ...
   */
  public abstract static class Reversed<T> extends PagedIterator<T> {
