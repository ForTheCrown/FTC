...
import static net.forthecrown.cosmetics.emotes.EmoteJingle.JingleNote.BASS;
import static net.forthecrown.cosmetics.emotes.EmoteJingle.JingleNote.SNARE;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.EMOTE_JINGLE_COOLDOWN;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.jingleSender;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.jingleTarget;
...
public class EmoteJingle extends Emote {

  public EmoteJingle() {
    super("jingle", 6 * 20, EMOTE_JINGLE_COOLDOWN);

    setDescription("Plays a christmas song. :)");
    setPermission(EmotePermissions.EMOTE_JINGLE);
