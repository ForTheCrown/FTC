...
import static net.forthecrown.cosmetics.emotes.EmoteMessages.EMOTE_HUG_COOLDOWN;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.EMOTE_HUG_SELF;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.hugReceived;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.hugSender;
import static net.forthecrown.cosmetics.emotes.EmoteMessages.hugTarget;
...
public class EmoteHug extends Emote {
  ...
  public EmoteHug() {
    ...
    setPermission(EmotePermissions.EMOTE_HUG);
