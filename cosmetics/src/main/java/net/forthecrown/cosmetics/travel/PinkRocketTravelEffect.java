...
public class PinkRocketTravelEffect implements TravelEffect {
  ...
  private static final Particle.DustTransition dustTransition
      = new Particle.DustTransition(Color.fromRGB(255, 146, 112), Color.fromRGB(255, 192, 211), 3.0F); // Put outside tick

  private static final Particle.DustOptions dustOptions
      = new Particle.DustOptions(Color.fromRGB(255, 192, 211), 3.0F); // Put outside tick
