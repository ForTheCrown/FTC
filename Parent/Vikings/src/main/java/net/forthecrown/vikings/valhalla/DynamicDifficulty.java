...
public class DynamicDifficulty {
    ...
    private StaticDifficulty base;

    public DynamicDifficulty(RaidParty party, StaticDifficulty base){
        this.party = party;
        this.base = base;
    }
    ...
    public void calculateModifier(){
        ...
        Collection<Player> players = party.getParticipants();
    ...
    public StaticDifficulty getBase() {
        return base;
    }

    public void setBase(StaticDifficulty base) {
        this.base = base;
    }
