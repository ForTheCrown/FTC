...
public class VikingBuilds {
    ...
    public static final String[] MEDIUM_HOUSES = {"raid_house_2"};
    public static final String[] LARGE_HOUSES = {"raid_barn_1", "raid_house_6", "raid_house_1"};
    public static final String[] SMALL_HOUSES = {"raid_house_4", "raid_house_5"};
    ...
    public static String replacePlaceholders(String str){
        if(str.isBlank()) str = randomFromArray(MEDIUM_HOUSES);
        else {
            str = str.replaceAll("placeholder_medium", randomFromArray(MEDIUM_HOUSES));
