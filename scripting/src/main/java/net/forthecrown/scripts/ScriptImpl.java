...
class ScriptImpl implements Script {
  ...
  public ScriptImpl(Source source) {
      ...
      throws IllegalStateException
  {
    ...
    if (binding instanceof ScriptImpl script) {
      addChild(script);
    }
  ...
  Object toScriptObject(String label, Object o) {
    ...
    if (o instanceof ScriptImpl other) {
  ...
  public ExecResult<Object> evaluate() {
    ...
    try (Context ctx = enterContext()) {
      try {
        ...
        return ExecResultImpl.success(o, this);
      } catch (Throwable t) {
  ...
  public ExecResult<Object> invoke(String methodName, Object... arguments) {
    ...
    try (Context ctx = enterContext()) {
      ...
      try {
        ...
        return ExecResultImpl.success(returnValue, methodName, this);
      } catch (Throwable exc) {
  ...
  public Script addChild(Script child) {
    if (children.add(child)) {
      ((ScriptImpl) child).setParent(this);
    }
  ...
  public Script removeChild(Script child) {
    if (children.remove(child)) {
      ((ScriptImpl) child).setParent(null);
    }
