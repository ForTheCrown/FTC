...
public final class AuctionManager {
    ...
    public static final FtcBoundingBox AUCTION_AREA = new FtcBoundingBox(Worlds.OVERWORLD, -657, 49, 3848, -616, 21, 3810);

    public AuctionManager(){
        Bukkit.getPluginManager().registerEvents(new AuctionEvents(), Crown.inst());
    ...
    public void loadAuctions(){
        File directory = new File(Crown.dataFolder() + File.separator + "auctions");
