...
public class MarketShop implements JsonSerializable {
    private final ProtectedRegion wgRegion;
    private final MarketShopEntrance[] doors;
    ...
    public MarketShop(ProtectedRegion wgRegion, MarketShopEntrance[] doors, World world, BoundingBox example, Vector3i min, int price) {
    ...
    public MarketShop(JsonElement element, String regionName) {
        ...
        this.doors = json.getArray("doors", MarketShopEntrance::fromJson, MarketShopEntrance[]::new);
    ...
    public void testCanPurchase(CrownUser user, Balances balances, MarketShops shops) throws CommandSyntaxException {
    ...
    public void unclaim() {
        for (MarketShopEntrance e: doors) {
            e.onUnclaim(world);
        }
    ...
    public MarketShopEntrance[] getDoors() {
        return doors;
    }
    ...
    public JsonObject serialize() {
        ...
        json.addArray("doors", doors, MarketShopEntrance::serialize);
