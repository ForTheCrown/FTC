...
public enum Rank implements JsonSerializable {
    //royals
    KNIGHT (        "&8[&7Knight&8] &r",            Faction.ROYALS,  "free-rank",         RankTier.FREE),
    BARON (         "&8[&7Baron&8] &r",             Faction.ROYALS,  "free-rank",         RankTier.FREE),
    BARONESS(       "&8[&7Baroness&8] &r",          Faction.ROYALS,  "free-rank",         RankTier.FREE),
    ...
    Rank(String tabPrefix, Faction faction, String lpRank, RankTier tier){
