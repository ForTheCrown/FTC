...
import net.forthecrown.economy.util.RegionCopyPaste;
...
public class MarketReset {
  ...
  /**
   * Creates, aka copies, a template from the shop's placement area and pastes it to the copy area
   * to use to later reset the shop.
   *
