...
import net.forthecrown.core.serializer.AbstractSerializer;
import net.forthecrown.core.user.data.SoldMaterialData;
import net.forthecrown.core.user.data.UserTeleport;
import net.forthecrown.core.user.enums.*;
...
public class FtcUser extends AbstractSerializer<CrownCore> implements CrownUser {
    ...
    public FtcUser(@NotNull UUID base){
        ...
        net.forthecrown.core.user.UserManager.LOADED_USERS.put(base, this);
    ...
    public void unload(){
        save();
        net.forthecrown.core.user.UserManager.LOADED_USERS.remove(this.getUniqueId());
        handle = null;
    }
    ...
    public @NonNull HoverEvent<Component> asHoverEvent(@NonNull UnaryOperator<Component> op) {
        ...
        if(interactions.marriedTo != null && publicProfile){
            text
                    .append(Component.text("Married to: ").append(net.forthecrown.core.user.UserManager.getUser(interactions.marriedTo).nickOrName()))
                    .append(Component.newline());
        }
    ...
    public void updateVanished(){
        ...
        for (CrownUser u: net.forthecrown.core.user.UserManager.getOnlineUsers()){
