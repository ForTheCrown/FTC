package net.forthecrown.core.commands.manager;

import com.mojang.brigadier.arguments.IntegerArgumentType;
import net.forthecrown.core.CrownCore;
import net.forthecrown.core.clickevent.ClickEventCommand;
import net.forthecrown.core.commands.*;
import net.forthecrown.core.commands.arguments.*;
import net.forthecrown.core.commands.emotes.*;
import net.forthecrown.core.commands.marriage.*;
import net.forthecrown.core.commands.punishments.*;
