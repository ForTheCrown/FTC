...
public interface UserInteractions extends SocialInteractionsService, UserAttachment {
    ...
    /**
     * Handles the teleport request that this player will send
     * @param request The request this user will send out
     */
    void handleTeleport(TeleportRequest request);

    /**
     * Receives a teleport request, SHOULD NOT BE USED NORMALLY
