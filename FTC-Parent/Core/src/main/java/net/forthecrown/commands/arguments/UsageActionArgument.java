 ...
 */
public class UsageActionArgument implements ArgumentType<Key> {
    private static final UsageActionArgument INSTANCE = new UsageActionArgument();
    private UsageActionArgument() {}
    ...
    public static UsageActionArgument action(){
        return INSTANCE;
    }
