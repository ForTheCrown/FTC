...
public class DeathEffectArgument implements ArgumentType<AbstractDeathEffect> {
    private static final DeathEffectArgument INSTANCE = new DeathEffectArgument();
    private DeathEffectArgument() {}
    ...
    public static DeathEffectArgument deathEffect(){
        return INSTANCE;
    }
