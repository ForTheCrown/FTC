...
public class StepResult {
   ...
   * byte takes up way less space than an entire enum class along with UTF-8 encoded constant names,
   * integer ordinals and so on
   *
   * @see #SUCCESS
   * @see #FAILED
   * @see #MAX_DEPTH
   ...
   *
   * @param sections Newly created child sections leading off into further rooms
