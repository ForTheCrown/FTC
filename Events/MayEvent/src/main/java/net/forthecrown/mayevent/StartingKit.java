...
public class StartingKit {
    public static void give(Player player){
        ItemStack grenades = new ItemStackBuilder(Material.FIRE_CHARGE, 5).build();
        ...
        inv.setItem(EquipmentSlot.HEAD, new ItemStack(Material.IRON_HELMET));
        inv.setItem(EquipmentSlot.CHEST, new ItemStackBuilder(Material.IRON_CHESTPLATE).setUnbreakable(true).build());
        inv.setItem(EquipmentSlot.LEGS, new ItemStack(Material.IRON_LEGGINGS));
        inv.setItem(EquipmentSlot.FEET, new ItemStack(Material.IRON_BOOTS));
